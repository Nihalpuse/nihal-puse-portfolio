        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {education.map((item, i) => (
            <Reveal key={item.degree} delay={i * 0.05}>
              <div className="glass h-full rounded-xl p-6 shadow-[0_8px_30px_rgba(0,0,0,0.2)] transition duration-300 ease-out hover:-translate-y-0.5 hover:ring-1 hover:ring-accent/20">
